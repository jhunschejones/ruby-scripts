...
review_days.each do |review_day|
  minutes_entries = review_minutes_per_day[review_day].uniq.size
  daily_study_time_entries << "Date: #{review_day}, Total minutes: #{minutes_entries}"
  puts "#{"Date:".gray} #{review_day}#{", Total minutes:".gray} #{minutes_entries.to_s.bold}"
end
